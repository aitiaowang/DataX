...
//        configuration.root = JSON.parse(jsonTest());
//        System.out.println(configuration.root);
//
////      python datax.py -r rdbmsreader -w mysqlwriter
////        python datax.py hana2mysql1.json
//    }
